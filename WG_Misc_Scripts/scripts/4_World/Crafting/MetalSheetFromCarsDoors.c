class CraftMetalSheetFromCarsDoors extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Scrap metal";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CarDoor");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WG_ScrapCrate");//add results here
	...
	{		
		if(ingredients[0].GetHierarchyParent())
			return false;
		return true;
	}
